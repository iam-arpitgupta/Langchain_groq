...
if "vector" not in st.session_state:
    ...
    st.session_state.docs=session_state.loader.load()

    st.session_state.chunk_documents=RecursiveCharacterTextSplitter(chunk_sixe=1000,chunk_overlap=200)
...
prompt=ChatPromptTemplate.from_template(
    """
    Answer the questions based on the contexts only.
